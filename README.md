...
C++ program for managing customers and inventory with purchase and return tracking.
...
operator[](UTString name) to access or add a customer

isMember(UTString name) to check membership
...
Inventory Books 10
Purchase Alice Books 3
Purchase Bob Dice 5
Return Alice Books 1
Summarize


Output

There are 9 Books 5 Dice 0 Figures and 0 Towers in inventory
we have had a total of 2 different customers
Alice has purchased the most Books (2)
Bob has purchased the most Dice (5)
